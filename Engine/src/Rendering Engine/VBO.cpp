...
Engine::VBO::VBO(std::vector<Vertex> verticies)
{
...
void Engine::VBO::update(std::vector<Vertex> verticies)
{
    glBufferData(
        GL_ARRAY_BUFFER,
...
void Engine::VBO::setVertexAttributes()
{
    // Position attribute
